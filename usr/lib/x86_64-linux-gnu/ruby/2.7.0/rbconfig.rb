...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/x86_64-linux-gnu/ruby/2.7.0")
  ...
  CONFIG["ruby_install_name"] = "$(RUBY_BASE_NAME)2.7"
  CONFIG["RUBY_INSTALL_NAME"] = "$(RUBY_BASE_NAME)2.7"
  CONFIG["RUBY_SO_NAME"] = "ruby-2.7"
  CONFIG["exec"] = "exec"
  ...
  CONFIG["configure_args"] = " '--prefix=/usr' '--enable-multiarch' '--target=x86_64-linux-gnu' '--program-suffix=2.7' '--with-soname=ruby-2.7' '--enable-shared' '--disable-rpath' '--with-sitedir=/usr/local/lib/site_ruby' '--with-sitearchdir=/usr/local/lib/x86_64-linux-gnu/site_ruby' '--runstatedir=/var/run' '--localstatedir=/var' '--sysconfdir=/etc' 'AS=x86_64-linux-gnu-as' 'CC=x86_64-linux-gnu-gcc' 'CXX=x86_64-linux-gnu-g++' 'LD=x86_64-linux-gnu-ld' '--enable-ipv6' '--with-dbm-type=gdbm_compat' '--with-compress-debug-sections=no' 'CFLAGS=-g -O2 -ffile-prefix-map=/build/reproducible-path/ruby2.7-2.7.4=. -fstack-protector-strong -Wformat -Werror=format-security' 'CPPFLAGS=-Wdate-time -D_FORTIFY_SOURCE=2' 'CXXFLAGS=-g -O2 -ffile-prefix-map=/build/reproducible-path/ruby2.7-2.7.4=. -fstack-protector-strong -Wformat -Werror=format-security' 'DFLAGS=-frelease' 'FCFLAGS=-g -O2 -ffile-prefix-map=/build/reproducible-path/ruby2.7-2.7.4=. -fstack-protector-strong' 'FFLAGS=-g -O2 -ffile-prefix-map=/build/reproducible-path/ruby2.7-2.7.4=. -fstack-protector-strong' 'GCJFLAGS=-g -O2 -ffile-prefix-map=/build/reproducible-path/ruby2.7-2.7.4=. -fstack-protector-strong' 'LDFLAGS=-Wl,-z,relro -Wl,-z,now' 'OBJCFLAGS=-g -O2 -ffile-prefix-map=/build/reproducible-path/ruby2.7-2.7.4=. -fstack-protector-strong -Wformat -Werror=format-security' 'OBJCXXFLAGS=-g -O2 -ffile-prefix-map=/build/reproducible-path/ruby2.7-2.7.4=. -fstack-protector-strong -Wformat -Werror=format-security' 'target_alias=x86_64-linux-gnu'"
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "x86_64-linux-gnu-gcc (Debian 10.2.1-6) 10.2.1 20210110\nCopyright (C) 2020 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["GCC"] = "yes"
  CONFIG["CXXFLAGS"] = "-g -O2 -ffile-prefix-map=/build/reproducible-path/ruby2.7-2.7.4=. -fstack-protector-strong -Wformat -Werror=format-security"
  ...
  CONFIG["LDFLAGS"] = "-L. -Wl,-z,relro -Wl,-z,now -fstack-protector-strong -rdynamic -Wl,-export-dynamic"
  CONFIG["CFLAGS"] = "-g -O2 -ffile-prefix-map=/build/reproducible-path/ruby2.7-2.7.4=. -fstack-protector-strong -Wformat -Werror=format-security -fPIC"
  ...
  CONFIG["program_transform_name"] = "s&$$&2.7&;s&^&&"
